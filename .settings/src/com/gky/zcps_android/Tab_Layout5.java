...
public class Tab_Layout5 extends Activity {
	...
	private Button button_vote, button_cancelvote, button_pinfensave,
	...
	private RadioGroup radioGroup_poge;
...
*/
	...
	private String submitPinfen() {
		...
		String params = "pwhid=" + URLEncoder.encode(pwhid) + 
				...
				"&" + "poge=" + URLEncoder.encode(poge) + 
				"&" + "content=" + URLEncoder.encode(content) + 
				"&" + "total=" + URLEncoder.encode(total);
