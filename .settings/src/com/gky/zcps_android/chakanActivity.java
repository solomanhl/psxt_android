    ...
    */
	...
	public class MyListAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			}else if("通过".equals((String) data.get(position).get("pogejieguo"))){
				zuJian.pogejieguo.setTextColor(0x8800AA00);//绿色
				zuJian.pogejieguo.setText((String) data.get(position).get("pogejieguo"));
			}else if("不通过".equals((String) data.get(position).get("pogejieguo"))){
